...
<ul id="tabs-swipe-demo" class="tabs">
    ...
    <li class="tab col s3"><a class="active" href="#test-swipe-2">Weekly Report</a></li>
    <li class="tab col s3"><a target="_self" href='/month'>Monthly Report</a></li>
    <li class="tab col s3"><a target="_self"  href='/year'>Year Report</a></li>
</ul>
...
<div id="test-swipe-3" class="container"></div>
<div id="test-swipe-4" class="container"></div>
